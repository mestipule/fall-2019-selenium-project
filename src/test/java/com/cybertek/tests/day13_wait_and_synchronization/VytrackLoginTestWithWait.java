...
public class VytrackLoginTestWithWait {
    ...
    WAITS AND SYNCHRONIZATION
                    ...
                    ***  Where to put implicit wait *****
                    ...
                    Explicit Waits -> another type of wait from selenium
                                   -> allow us to wait for certain conditions to happen
                                   -> we can wait for specific action to happen
                                   -> things we wait for:
                                            element to be visible on the page
                                            element to be clickable
                                            title to have certain number of elements load
                                  -> official source, you won't use all of them but this is a good resource
                                    https://www.selenium.dev/selenium/docs/api/java/org/openqa/selenium/support/ui/ExceptionConditions.html
    ...
    */
    ...
    public void test() {
        ...
        //  .submit() only works when you have a form
        password.submit();
